...
use lib qw(/home/petersjg/meme/lib/meme-5.4.1/perl);
...
unless ($@) {
  Log::Log4perl::init('/home/petersjg/meme/share/meme-5.4.1/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/home/petersjg/meme/var/meme-5.4.1/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/home/petersjg/meme/share/meme-5.4.1/job_status.tmpl');
